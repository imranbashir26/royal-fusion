    ...
    >
      <div className="container-lux flex h-20 items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-1">
          ...
          <IconButton ariaLabel="Account" className="hidden sm:grid">
            <User className="h-5 w-5" aria-hidden="true" />
          </IconButton>
          <Link
            aria-label="Wishlist"
            className="relative grid h-10 w-10 place-items-center rounded-full text-brownroyal transition hover:bg-champagne/12 hover:text-burgundy"
            to="/wishlist"
          >
