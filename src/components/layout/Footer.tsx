  ...
  return (
    <footer className="border-t border-champagne/30 bg-burgundy text-ivory">
      <div className="container-lux grid gap-10 py-14 lg:grid-cols-[1.2fr_2fr_1.2fr]">
        <div>
          ...
          <p className="mt-5 max-w-sm text-sm leading-7 text-ivory/72">
            Premium fragrance impressions, attars, and gift-ready perfume experiences
            made for elegance, confidence, and lasting presence.
          </p>
          <a
      ...
      <div className="border-t border-ivory/10 py-5 text-center text-xs text-ivory/60">
        Royal Fusion. Luxury perfume eCommerce prototype.
      </div>
    </footer>
  )
}
