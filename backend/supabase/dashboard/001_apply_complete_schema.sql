-- Royal Fusion complete schema for a new empty Supabase project.
-- Generated from migrations 001 and 002 in migration order.
-- Contains schema and security objects only; no starter catalog or secrets.
...
-- ============================================================================
-- Migration 002: launch schema foundation
-- ============================================================================
